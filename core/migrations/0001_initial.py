# Generated by Django 4.0.4 on 2022-05-13 13:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('REJECTED', 'Rejected'), ('ACCEPTED', 'Accepted'), ('PENDING', 'Pending'), ('COMPLETED', 'Completed')], default='PENDING', max_length=128)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='core.image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('del_choice', models.CharField(choices=[('DS', 'Delivery service'), ('PU', 'Pick up'), ('PB', 'Postbox'), ('SWS', 'Speak with seller')], max_length=128)),
                ('bid_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.userbids')),
            ],
            options={
