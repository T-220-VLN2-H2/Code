    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('condition', models.CharField(choices=[('NEW', ''), ('USED', ''), ('USED_LIKE_NEW', ''), ('FOR_PARTS', 'For parts: not working')], max_length=128)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.catagory')),
            ],
            options={
                'db_table': 'core_item',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('users', models.ManyToManyField(through='core.RatingUsers', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='user_rating',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.userratings'),
        ),
        migrations.CreateModel(
            name='OrderUser',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('Buyer', ''), ('Seller', '')], max_length=128)),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.order')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        ...
        migrations.AddField(
            model_name='order',
            name='users',
            field=models.ManyToManyField(through='core.OrderUser', to=settings.AUTH_USER_MODEL),
        ),
    ]
